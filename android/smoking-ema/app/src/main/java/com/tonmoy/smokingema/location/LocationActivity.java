...
import com.tonmoy.smokingema.BuildConfig;
...
public class LocationActivity extends FragmentActivity implements
     ...
     */
    private static final long MAX_WAIT_TIME = UPDATE_INTERVAL * 1; // Every 20 seconds.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestUpdatesButton = (Button) findViewById(R.id.buttonStartLocationUpdates);
        mRemoveUpdatesButton = (Button) findViewById(R.id.buttonRemoveUpdates);
...
//        return PendingIntent.getService(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void requestLocationUpdates(View view) {
        try {
            ...
            Toast.makeText(this, "Starting Location Collection", Toast.LENGTH_SHORT).show();
